 ...
 *
 * <p>IMPORTANT: This service uses string-based @ConditionalOnClass to avoid
 * ClassNotFoundException when Caffeine dependencies are not present.
 *
 * <p>Safety mechanism:
 * <ul>
 *   <li>Uses string-based @ConditionalOnClass("com.github.benmanes.caffeine.cache.Caffeine")</li>
 *   <li>Only loaded when Caffeine is on the classpath</li>
 *   <li>Falls back to InMemoryTokenBlacklistService if Caffeine is missing</li>
 *   <li>Direct imports are safe because @Service registration is conditional</li>
 * </ul>
 *
 * <p>Note: Caffeine is typically included as 'implementation' dependency in simplix-auth,
 * making it always available. However, the conditional ensures flexibility for custom builds.
 */
@Service
