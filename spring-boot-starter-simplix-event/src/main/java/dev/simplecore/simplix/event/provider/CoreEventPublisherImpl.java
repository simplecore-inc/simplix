...
public class CoreEventPublisherImpl implements EventPublisher {
    ...
    private static UnifiedEventPublisher unifiedEventPublisher;

    @Autowired(required = false)
    public void setUnifiedEventPublisher(UnifiedEventPublisher publisher) {
        CoreEventPublisherImpl.unifiedEventPublisher = publisher;
        if (publisher != null) {
            log.info("CoreEventPublisherImpl initialized with UnifiedEventPublisher");
        }
    }
