...
|----------|-------------|
| [Overview](ko/license/overview.md) | 모듈 아키텍처와 판정 흐름 |
| [Activation Guide](ko/license/activation-guide.md) | 온라인·오프라인 라이선스 등록 절차 |
| [Enforcement Guide](ko/license/enforcement-guide.md) | 기능 게이팅과 수량 제한 적용 |
| [Configuration Reference](ko/license/configuration.md) | 설정 옵션 전체 목록 |
