...
simplix-sync는 베스트-에포트 전송입니다. 비즈니스 critical한 데이터는 simplix-messaging(JetStream/Streams) 사용. simplix-sync는 [Reconciliation](ko/sync/advanced-guide.md#reconciliation)으로 보완하세요.
...
- [Overview](ko/sync/overview.md) - 모듈 개요, 아키텍처, 백엔드 비교, 설정 속성
