...
- ✔ **유니크 검증** - @Unique (필드 레벨), @UniqueFields (클래스 레벨) DB 기반 유니크 검증, soft delete 지원
...
- [Overview (아키텍처 상세)](ko/core/overview.md)
- [Entity & Repository Guide (엔티티/리포지토리)](ko/core/entity-repository.md)
- [Tree Structure Guide (트리 구조)](ko/core/tree-structure.md)
- [Type Converters Guide (타입 변환)](ko/core/type-converters.md)
- [Security Guide (보안)](ko/core/security.md)
- [Exception & API Guide (예외/API)](ko/core/exception-api.md)
- [Cache Guide (캐시)](ko/core/cache.md)
