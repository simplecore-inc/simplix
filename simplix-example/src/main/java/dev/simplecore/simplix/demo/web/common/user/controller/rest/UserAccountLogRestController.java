...
@Tag(name = "simplix.demo.UserAccountLog", description = "사용자 계정 변경로그")
public class UserAccountLogRestController extends SimpliXBaseController<UserAccountLog, UserAccountLogId> {
     ...
     */
    @PostMapping("/create")
    @Operation(summary = "Create UserAccountLog", description = "Creates a new 사용자 계정 변경로그")
    @SimpliXStandardApi
    ...
    @Operation(summary = "Update UserAccountLog", description = "Updates existing 사용자 계정 변경로그")
    @SimpliXStandardApi
     ...
     */
    @PatchMapping
    @Operation(summary = "Update Multiple UserAccountLog", description = "Updates multiple existing 사용자 계정 변경로그s")
    @SimpliXStandardApi
    @PreAuthorize("hasPermission('UserAccountLog', 'edit')")
    ...
    @Operation(summary = "Delete UserAccountLog", description = "Deletes 사용자 계정 변경로그 by ID")
    @SimpliXStandardApi
    ...
    @Operation(summary = "Get UserAccountLog", description = "Retrieves 사용자 계정 변경로그 by ID")
    @SimpliXStandardApi
     ...
     */
    @PatchMapping("/batch")
    @Operation(summary = "Batch Update UserAccountLogs", description = "Updates multiple 사용자 계정 변경로그s")
    @SimpliXStandardApi
    @PreAuthorize("hasPermission('UserAccountLog', 'edit')")
     ...
     */
    @DeleteMapping("/batch")
    @Operation(summary = "Delete multiple UserAccountLogs", description = "Deletes multiple 사용자 계정 변경로그s by their IDs")
    @SimpliXStandardApi
    @PreAuthorize("hasPermission('UserAccountLog', 'delete')")
     ...
     */
    @GetMapping("/search")
    @Operation(summary = "Search UserAccountLog list (GET)", description = "Searches 사용자 계정 변경로그s with various conditions using GET method")
    @SimpliXStandardApi
     ...
     */
    @PostMapping("/search")
    @Operation(summary = "Search UserAccountLog list (POST)", description = "Searches 사용자 계정 변경로그s with various conditions using POST method")
    @SimpliXStandardApi
    @PreAuthorize("hasPermission('UserAccountLog', 'list')")
    public ResponseEntity<SimpliXApiResponse<Page<UserAccountLogListDTO>>> search(
