...
@Tag(name = "common.user.UserAccount", description = "사용자 계정")
public class UserAccountRestController extends SimpliXBaseController<UserAccount, String> {
     ...
     */
    @PostMapping("/create")
    @Operation(summary = "Create UserAccount", description = "Creates a new 사용자 계정")
    @SimpliXStandardApi
     ...
     */
    @PutMapping("/{id}")
    @Operation(summary = "Update UserAccount", description = "Updates existing 사용자 계정")
    @SimpliXStandardApi
    ...
    public ResponseEntity<SimpliXApiResponse<UserAccountDetailDTO>> update(@PathVariable String id, @RequestBody @Validated UserAccountUpdateDTO updateDto) {
      ...
      */
      @PatchMapping
      @Operation(summary = "Update Multiple UserAccount", description = "Updates multiple existing 사용자 계정s")
      @SimpliXStandardApi
     ...
     */
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete UserAccount", description = "Deletes 사용자 계정 by ID")
    @SimpliXStandardApi
     ...
     */
    @GetMapping("/{id}")
    @Operation(summary = "Get UserAccount", description = "Retrieves 사용자 계정 by ID")
    @SimpliXStandardApi
     ...
     */
    @PatchMapping("/batch")
    @Operation(summary = "Batch Update UserAccounts", description = "Updates multiple 사용자 계정s")
    @SimpliXStandardApi
    @PreAuthorize("hasPermission('UserAccount', 'edit')")
     ...
     */
    @DeleteMapping("/batch")
    @Operation(summary = "Delete multiple UserAccounts", description = "Deletes multiple 사용자 계정s by their IDs")
    @SimpliXStandardApi
    @PreAuthorize("hasPermission('UserAccount', 'delete')")
     ...
     */
    @GetMapping("/search")
    @Operation(summary = "Search UserAccount list (GET)", description = "Searches 사용자 계정s with various conditions using GET method")
    @SimpliXStandardApi
     ...
     */
    @PostMapping("/search")
    @Operation(summary = "Search UserAccount list (POST)", description = "Searches 사용자 계정s with various conditions using POST method")
    @SimpliXStandardApi
    @PreAuthorize("hasPermission('UserAccount', 'list')")
    public ResponseEntity<SimpliXApiResponse<Page<UserAccountListDTO>>> search(
    ...
    @GetMapping("/excel")
    @Operation(summary = "Export UserAccount list to Excel", description = "Exports 사용자 계정s to Excel file with various conditions using GET method")
    @PreAuthorize("hasPermission('UserAccount', 'list')")
    ...
    @PostMapping("/excel")
    @Operation(summary = "Export UserAccount list to Excel (POST)", description = "Exports 사용자 계정s to Excel file with various conditions using POST method")
    @PreAuthorize("hasPermission('UserAccount', 'list')")
     ...
     */
    @GetMapping("/me")
    @Operation(summary = "Get Current User", description = "현재 로그인한 사용자의 계정 정보를 조회합니다")
    @SimpliXStandardApi
