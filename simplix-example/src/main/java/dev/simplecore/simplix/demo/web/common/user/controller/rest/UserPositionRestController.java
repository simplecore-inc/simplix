...
@Tag(name = "common.user.UserPosition", description = "사용자 직급")
public class UserPositionRestController extends SimpliXBaseController<UserPosition, String> {
     ...
     */
    @PostMapping("/create")
    @Operation(summary = "Create UserPosition", description = "Creates a new 사용자 직급")
    @SimpliXStandardApi
     ...
     */
    @PutMapping("/{id}")
    @Operation(summary = "Update UserPosition", description = "Updates existing 사용자 직급")
    @SimpliXStandardApi
    ...
    public ResponseEntity<SimpliXApiResponse<UserPositionDetailDTO>> update(
      ...
      */
      @PatchMapping
      @Operation(summary = "Update Multiple UserPosition", description = "Updates multiple existing 사용자 직급s")
      @SimpliXStandardApi
      @PreAuthorize("hasPermission('UserPosition', 'edit')")
     ...
     */
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete UserPosition", description = "Deletes 사용자 직급 by ID")
    @SimpliXStandardApi
     ...
     */
    @GetMapping("/{id}")
    @Operation(summary = "Get UserPosition", description = "Retrieves 사용자 직급 by ID")
    @SimpliXStandardApi
     ...
     */
    @PatchMapping("/batch")
    @Operation(summary = "Batch Update UserPositions", description = "Updates multiple 사용자 직급s")
    @SimpliXStandardApi
    @PreAuthorize("hasPermission('UserPosition', 'edit')")
    public ResponseEntity<SimpliXApiResponse<Void>> batchUpdate(@RequestBody @Validated UserPositionBatchUpdateDTO batchUpdateDto) {
        try {
     ...
     */
    @DeleteMapping("/batch")
    @Operation(summary = "Delete multiple UserPositions", description = "Deletes multiple 사용자 직급s by their IDs")
    @SimpliXStandardApi
    @PreAuthorize("hasPermission('UserPosition', 'delete')")
     ...
     */
    @GetMapping("/search")
    @Operation(summary = "Search UserPosition list (GET)", description = "Searches 사용자 직급s with various conditions using GET method")
    @SimpliXStandardApi
     ...
     */
    @PostMapping("/search")
    @Operation(summary = "Search UserPosition list (POST)", description = "Searches 사용자 직급s with various conditions using POST method")
    @SimpliXStandardApi
    @PreAuthorize("hasPermission('UserPosition', 'list')")
    public ResponseEntity<SimpliXApiResponse<Page<UserPositionListDTO>>> search(
